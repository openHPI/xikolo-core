...
RSpec.describe 'Multiple Choice Questions: Update', type: :request do
  subject(:resource) { api.rel(:multiple_choice_question).put(payload, params: {id: question.id}).value! }
