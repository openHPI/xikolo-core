  ...
  describe 'vendor data' do
    context 'nil' do
      ...
      it 'creates a new quiz submission' do
        ...
        expect(QuizSubmission.find_by(quiz_id: quiz.id).vendor_data).to eq({})
      end
    end
