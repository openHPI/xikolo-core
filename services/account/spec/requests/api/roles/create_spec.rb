...
describe 'Role: Create', type: :request do
  ...
  it 'responds with a follow location to created resource' do
    expect(resource.follow.to_s).to eq account_service.role_url(AccountService::Role.last)
  end
  ...
  context 'with invalid name' do
    ...
    it 'does not create record' do
      expect do
        ...
        nil
      end.not_to change(AccountService::Role, :count)
    end
  end
end
