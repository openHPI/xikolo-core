...
describe PinboardService::VotesController, type: :controller do
  ...
  describe "GET 'index'" do
    ...
    it 'answers with vote resources' do
      get :index
      expect(json[0]).to eq(PinboardService::VoteDecorator.new(vote).as_json.stringify_keys)
    end
  end
  ...
  describe "POST 'create'" do
    it 'responds with 201 Created' do
      atts = attributes_for(:'pinboard_service/vote', votable_type: 'Question')
    ...
    it 'creates a vote on create' do
      expect do
        ...
        atts[:votable_id] = unvoted_uncommented_question.id
        post :create, params: atts
      end.to change(PinboardService::Vote, :count).by(1)
    end
    ...
    it 'does not create a vote twice' do
      expect do
        ...
        post :create, params: atts
      end.not_to change(PinboardService::Vote, :count)
    end
