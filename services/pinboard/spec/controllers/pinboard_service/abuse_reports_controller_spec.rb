...
describe PinboardService::AbuseReportsController, type: :controller do
  ...
  describe 'create' do
    shared_examples_for 'invalid input' do
      ...
      it 'does not create a report' do
        expect { action.call }.not_to change(PinboardService::AbuseReport, :count)
      end
    end
    ...
    it 'creates a report' do
      expect { action.call }.to change(PinboardService::AbuseReport, :count).by 1
    end
