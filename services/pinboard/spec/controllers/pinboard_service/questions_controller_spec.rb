...
describe PinboardService::QuestionsController, type: :controller do
  ...
  describe "GET 'index'" do
    ...
    describe 'querying for a course' do
      ...
      it 'answers with question resources' do
        index
        expect(json[0]).to eq(PinboardService::QuestionDecorator.new(question, context: {collection: true}).as_json.stringify_keys)
      end
  ...
  describe "GET 'show'" do
    ...
    it 'answers with a question resource' do
      get :show, params: {id: question.id}
      expect(json).to eq(PinboardService::QuestionDecorator.new(question).as_json.stringify_keys)
    end
  ...
  describe 'POST create' do
    ...
    it 'creates a question on create' do
      expect { creation }.to change(PinboardService::Question, :count).by(1)
    end
    ...
    context 'with non-existent tag' do
      ...
      it 'creates a tag with the question' do
        expect { creation }.to change(PinboardService::Tag, :count).by(1)
      end
    end
    ...
    context 'with image references' do
      ...
      it 'stores valid upload and creates a new richtext' do
        ...
        expect(PinboardService::Question.first.text).to include 's3://xikolo-pinboard'
      end
    ...
    context 'with attachment upload' do
      ...
      it 'stores file and use it afterwards' do
        ...
        expect(PinboardService::Question.last.attachment_uri).not_to be_nil
      end
    ...
    context 'with implicit tags' do
      ...
      it 'creates a question with the section tag' do
        expect do
          creation
        end.to change(PinboardService::Question, :count).from(1).to(2)
        expect(PinboardService::Question.order(created_at: :desc).first.tags.map(&:id)).to include section_tag.id
      end
      ...
      context 'with a non-existent tag name' do
        ...
        it 'creates a tag with the question' do
          expect { creation }.to change(PinboardService::ExplicitTag, :count).by(1)
        end
      end
    end

    it 'creates a subscription with the question' do
      expect { creation }.to change(PinboardService::Subscription, :count).by(1)
    end
    ...
    it 'creates a watch for the question and its author' do
      expect { creation }.to change(PinboardService::Watch, :count).from(0).to(1)
    end
    ...
    context 'with duplicates' do
      ...
      it 'does not create a Question' do
        expect { creation }.not_to change(PinboardService::Question, :count)
      end
    end
  ...
  describe "PUT 'update'" do
    ...
    describe 'with an Answer' do
      ...
      it 'can also change the accepted answer' do
        other_answer = PinboardService::Answer.create(question:)
  ...
  describe "DELETE 'destroy'" do
    ...
    it 'does not delete the question record' do
      expect { request }.not_to change(PinboardService::Question, :count)
    end
  end
end
