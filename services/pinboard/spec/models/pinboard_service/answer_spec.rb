...
describe PinboardService::Answer, type: :model do
  ...
  describe 'sorting' do
    ...
    context 'by sum of votes, same votes chronologically' do
      ...
      context 'votes descending, chronologically' do
        subject { PinboardService::Answer.order_by_votes(:desc).pluck :id }
      ...
      context 'ascending' do
        subject { PinboardService::Answer.order_by_votes(:asc).pluck :id }
