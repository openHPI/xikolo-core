...
Rails.application.configure do
  ...
  # ENV["RAILS_MASTER_KEY"], config/master.key, or an environment key
  # such as config/credentials/production.key. This key is used to
  ...
  # config.active_job.queue_name_prefix = "xikolo_collab_space_production"
