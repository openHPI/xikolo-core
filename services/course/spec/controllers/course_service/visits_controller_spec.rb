...
describe CourseService::VisitsController, type: :controller do
    ...
    context 'with valid params' do
      context 'without visit existing for course item' do
        ...
        it 'stores a new visit' do
          expect { creation }.to change(CourseService::Visit, :count).from(0).to(1)
        end
      end
      ...
      context 'with visit already existing for course item' do
        ...
        it 'does not create another visit' do
          expect { creation }.not_to change(CourseService::Visit, :count)
        end
