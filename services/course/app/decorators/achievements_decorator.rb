...
class AchievementsDecorator < ApplicationDecorator
  delegate_all
  ...
  def confirmation_download
    ...
    if model.cop.released?
      ...
      {
        available: false,
        description: I18n.t(:'achievements.certificates.confirmation.download.not_released'),
        url: nil,
        type: 'download',
      }
    end
  ...
  def achievement_download
    ...
    if model.roa.released?
      ...
      {
        available: false,
        description: I18n.t(:'achievements.certificates.achievement.download.not_released'),
        url: nil,
        type: 'download',
      }
    end
