...
describe NewsService::Recipient, type: :model do
  ...
  describe '::find' do
    ...
    context 'with user URN' do
      ...
      it { is_expected.to be_a NewsService::Recipient::User }
      ...
      context 'when message has consents' do
        ...
        it { is_expected.to be_a NewsService::FilterByConsents }
      end
    end
    ...
    context 'with group URN' do
      ...
      it { is_expected.to be_a NewsService::Recipient::Group }
