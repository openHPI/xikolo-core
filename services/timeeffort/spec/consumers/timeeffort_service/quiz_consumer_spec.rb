...
RSpec.describe TimeeffortService::QuizConsumer, type: :consumer do
  ...
  describe '#question_changed' do
    ...
    context 'w/o existing item' do
      ...
      it 'does not create a new TimeEffortJob' do
        quiz_event
        expect(TimeeffortService::TimeEffortJob.count).to eq 0
      end
    end
  end
  ...
  describe '#answer_changed' do
    ...
    context 'w/ existing question' do
      ...
      context 'w/o existing item' do
        ...
        it 'does not create a new TimeEffortJob' do
          expect { quiz_event }.not_to change(TimeeffortService::TimeEffortJob, :count)
        end
      end
    end
