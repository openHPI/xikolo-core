  ...
  describe '#processor' do
    ...
    context 'rich_text item' do
      ...
      it 'returns a RichTextProcessor' do
        expect(processor).to be_a Processors::RichTextProcessor
      end
    end
    ...
    context 'video item' do
      ...
      it 'returns a VideoProcessor' do
        expect(processor).to be_a Processors::VideoProcessor
      end
    end
    ...
    context 'quiz item' do
      ...
      it 'returns a QuizProcessor' do
        expect(processor).to be_a Processors::QuizProcessor
      end
    end
  end
end
