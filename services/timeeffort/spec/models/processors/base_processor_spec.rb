  ...
  describe '#patch_items!' do
    ...
    context 'w/ valid time effort' do
        ...
        context 'w/o time effort overwritten' do
          ...
          context 'w/ other error while patching course item' do
            ...
            it 'raises an error' do
              expect { patch_items }.to raise_error Errors::CourseItemUpdateError
            end
          end
        end
      end
      ...
      context 'w/o set_calculated_time_effort success' do
        ...
        let(:set_calculated_time_effort_operation) { Operation.with_errors({'some_field' => 'some_error'}) }
    ...
    context 'w/o valid time effort' do
      it 'raises an error' do
        expect { patch_items }.to raise_error Errors::InvalidTimeEffort
      end
    end
  end
end
