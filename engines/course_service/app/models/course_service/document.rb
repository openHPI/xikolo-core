...
class Document < ApplicationRecord # rubocop:disable Layout/IndentationWidth
  ...
  has_many :courses, -> { not_deleted }, through: :course_documents

  has_many :localizations, -> { not_deleted },
    class_name: 'CourseService::DocumentLocalization',
    inverse_of: :document
