...
module Structure # rubocop:disable Layout/IndentationWidth
  class Node < ApplicationRecord
    ...
    # renaming models.
    STI_TYPE_TO_CLASS = {
      'branch' => 'CourseService::Structure::Branch',
      'fork' => 'CourseService::Structure::Fork',
      'item' => 'CourseService::Structure::Item',
      'root' => 'CourseService::Structure::Root',
      'section' => 'CourseService::Structure::Section',
    }.freeze

    # What "type" should be used when storing each subclass?
    STI_CLASS_TO_TYPE = {
      'CourseService::Structure::Branch' => 'branch',
      'CourseService::Structure::Fork' => 'fork',
      'CourseService::Structure::Item' => 'item',
      'CourseService::Structure::Root' => 'root',
      'CourseService::Structure::Section' => 'section',
    }.freeze
