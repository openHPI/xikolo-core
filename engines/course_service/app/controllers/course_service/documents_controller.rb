...
class DocumentsController < ApplicationController # rubocop:disable Layout/IndentationWidth
  ...
  def index
    ...
    if params[:course_id].present?
      documents = documents.joins(:course_documents)
        .merge(CourseDocument.where(course_id: params[:course_id]))
    end
