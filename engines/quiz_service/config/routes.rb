...
QuizService::Engine.routes.draw do
  defaults format: :json do
    ...
    {
      multiple_answer_questions: 'QuizService::MultipleAnswerQuestion',
      multiple_choice_questions: 'QuizService::MultipleChoiceQuestion',
      free_text_questions: 'QuizService::FreeTextQuestion',
      essay_questions: 'QuizService::EssayQuestion',
    }.each do |path, klass|
    ...
    get '/submission_question_statistics/:id', to: 'submission_question_statistics#show',
      as: :submission_question_statistic
    # @deprecated
