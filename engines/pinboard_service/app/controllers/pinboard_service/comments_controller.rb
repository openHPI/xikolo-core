...
class CommentsController < ApplicationController # rubocop:disable Layout/IndentationWidth
  ...
  def index
    ...
    if params[:commentable_type].nil?
      ...
      respond_with comments.where commentable_type: "PinboardService::#{params[:commentable_type]}"
    else
      respond_with comments.where \
        commentable_id: params[:commentable_id],
        commentable_type: "PinboardService::#{params[:commentable_type]}"
    end
  end
