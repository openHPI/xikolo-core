...
class QuestionDecorator < Draper::Decorator # rubocop:disable Layout/IndentationWidth
  delegate_all
  ...
  def as_json(opts = {})
    ...
    if context[:collection]
      attrs.merge!(
        answer_count: public_answers.count,
        comment_count: public_comments.count,
        answer_comment_count: public_answer_comments.count
      )
    end
