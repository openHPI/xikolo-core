...
RSpec.describe 'News: Update with visual', type: :request do
  ...
  context 'when uploads first visual' do
    let(:store_stub_url) { %r{https://s3.xikolo.de/xikolo-public/news/[0-9a-zA-Z]+/visual_v1} }
  ...
  context 'when uploads another visual' do
    ...
    let(:store_stub_url) { %r{https://s3.xikolo.de/xikolo-public/news/[0-9a-zA-Z]+/visual_v2.png} }
    let(:old_store_stub_url) { %r{https://s3.xikolo.de/xikolo-public/news/[0-9a-zA-Z]+/visual_v1.png} }
    let!(:delete_old) do
      stub_request(:delete,
        'https://s3.xikolo.de/xikolo-public/news/asdf/visual_v1.png')
