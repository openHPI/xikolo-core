...
describe QuizService::Question, type: :model do
  subject(:question) { create(:'quiz_service/multiple_choice_question') }
  ...
  describe 'explanation' do
    let(:question) { build(:'quiz_service/multiple_choice_question', explanation: '') }
  ...
  context '(event publication)' do
    let(:question) { build(:'quiz_service/multiple_choice_question') }
