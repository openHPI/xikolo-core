...
describe QuizService::SubmissionStatistics, type: :model do
  ...
  context 'base stats' do
    before do
      question = create(:'quiz_service/multiple_choice_question', quiz:, points: 10)

      submission1 = create(
        :'quiz_service/quiz_submission',
        :submitted,
        quiz:,
  ...
  describe '#box_plot_distributions' do
    ...
    let(:other_quiz) { create(:'quiz_service/quiz') }

    before do
      allow(quiz).to receive(:max_points).and_return(10)
      allow(other_quiz).to receive(:max_points).and_return(100)

      submission1 = create(:'quiz_service/quiz_submission', :submitted, quiz_id: quiz.id)
      submission2 = create(:'quiz_service/quiz_submission', :submitted, quiz_id: quiz.id)
      submission3 = create(:'quiz_service/quiz_submission', :submitted, quiz_id: quiz.id)
      submission4 = create(:'quiz_service/quiz_submission', :submitted, quiz_id: quiz.id)
      submission5 = create(:'quiz_service/quiz_submission', :submitted, quiz_id: quiz.id)

      other_submission =
        create(:'quiz_service/quiz_submission', :submitted, quiz_id: other_quiz.id)
  ...
  describe '#questions_base_stats' do
    ...
    let(:question) do
      create(:'quiz_service/multiple_choice_question', quiz:, points: 10)
    end

    let!(:question_without_submissions) do
      create(:'quiz_service/multiple_answer_question', quiz:, points: 5)
    end

    let!(:question_zero_points) do
      create(:'quiz_service/multiple_choice_question', quiz:, points: 0)
    end
    ...
    before do
      ...
      # First question
      answer1 = create(:'quiz_service/answer', question:, correct: true)
      answer2 = create(:'quiz_service/answer', question:, correct: false)
      ...
      answer1 = create(:'quiz_service/answer', question: question_zero_points, correct: true)
      answer2 = create(:'quiz_service/answer', question: question_zero_points, correct: true)
