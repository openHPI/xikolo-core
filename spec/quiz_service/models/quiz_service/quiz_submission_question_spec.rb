...
describe QuizService::QuizSubmissionQuestion, type: :model do
  subject { quiz_submission_question }

  let(:params) { {} }
  let(:quiz_submission_question) { create(:'quiz_service/quiz_submission_question', params) }
  ...
  context 'similar quiz_submission with same quiz_' do
    ...
    let(:submission) { create(:'quiz_service/quiz_submission', :submitted) }
    let(:second_submission) { create(:'quiz_service/quiz_submission', :submitted) }
    ...
    let(:similar_quiz_submission_question) { build(:'quiz_service/quiz_submission_question', second_params) }
  ...
  context 'question points are nil' do
    ...
    let(:submission_question) { create(:'quiz_service/quiz_submission_question', points: nil, quiz_question_id:) }
    let(:submission_selectable_answer) { create(:'quiz_service/quiz_submission_selectable_answer', quiz_submission_question: submission_question, quiz_answer_id:) }
    let(:submission_free_text_answer) { create(:'quiz_service/quiz_submission_free_text_answer', quiz_submission_question: submission_question, quiz_answer_id:) }
    let(:submission_essay_answer) { create(:'quiz_service/quiz_submission_free_text_answer', :long_text, quiz_submission_question: submission_question, quiz_answer_id:) }
    ...
    context 'with a MultipleAnswerQuestion' do
      ...
      context 'with two selected answers' do
        ...
        let(:second_submission_selectable_answer) { create(:'quiz_service/quiz_submission_selectable_answer', quiz_submission_question: submission_question, quiz_answer_id: second_quiz_answer_id) }
