...
describe CourseService::EnrollmentsController, type: :controller do
  ...
  describe "GET 'index'" do
    ...
    it 'answers with enrollment resources' do
      get :index
      expect(json[0]).to eq CourseService::EnrollmentDecorator.new(enrollment).as_json(api_version: 1)
    end
    ...
    context 'with deleted courses' do
      ...
      context '(hard-deleted course)' do
        before do
          CourseService::Course.find(deleted_course_id).delete
        end
  ...
  describe "GET 'show'" do
    ...
    it 'answers with a enrollment resource' do
      get :show, params: {id: enrollment.id}
      expect(json.to_h).to eq CourseService::EnrollmentDecorator.new(enrollment).as_json(api_version: 1)
    end
  end
  ...
  describe "POST 'create'" do
    ...
    it 'creates an enrollment on create' do
      post :create, params: new_enrollment.attributes
      expect(CourseService::Enrollment.count).to eq 1
    end
