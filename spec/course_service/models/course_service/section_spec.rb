...
describe CourseService::Section, type: :model do
    ...
    describe 'course content tree' do
      context 'for legacy courses' do
        ...
        it 'does not create a node' do
          ...
          end.not_to change(CourseService::Structure::Node, :count)
        end
      end
      ...
      context 'for courses with content tree' do
        ...
        it 'creates a node' do
          ...
          expect(section.node).to be_a CourseService::Structure::Section
