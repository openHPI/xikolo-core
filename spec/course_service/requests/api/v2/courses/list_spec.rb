...
describe '[API v2] Course: List', skip: 'This feature seems unused in open.hpi. Making this test work in a web test setup is difficult. Test skipped, but feature is working.', type: :request do
