      ...
      context 'with existing grants' do
        ...
        let(:existing_grants) do
          [{
            ...
            group: grant_visitor_group,
            self_url: "http://localhost:3000/account_service/grants/#{existing_grant_id}",
          }]
        end
        ...
        [
          {
            ...
            role_name: 'course.visitor',
            group: grant_visitor_group,
            self_url: "http://localhost:3000/account_service/grants/#{grant_id}",
          },
        ]
      end
      let!(:delete_visitor_stub) do
        ...
        let(:additional_grant) do
          {
            ...
            self_url: "http://localhost:3000/account_service/grants/#{additional_grant_id}",
          }
        end
