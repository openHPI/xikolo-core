...
describe CourseService::EnrollmentDecorator, type: :decorator do
  ...
  it 'has a relation to reactivations' do
    expect(json['reactivations_url']).to eq h.course_service.enrollment_reactivations_path(enrollment)
  end
