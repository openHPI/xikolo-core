...
RSpec.describe TimeeffortService::Processors::RichTextProcessor, type: :model do
  ...
  describe '#calculate' do
    ...
    context 'w/ rich_text resource' do
      let(:rich_text_handler) { instance_double(TimeeffortService::ItemTypes::RichText) }
      ...
      it 'calls the richtext handler and sets the time effort correctly' do
        allow(TimeeffortService::ItemTypes::RichText).to receive(:new).and_return(rich_text_handler)
