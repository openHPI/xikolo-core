...
RSpec.describe TimeeffortService::TimeEffortJob, type: :model do
  ...
  describe '#schedule' do
    ...
    it 'enqueues a new job' do
      expect { schedule_job }.to have_enqueued_job(TimeeffortService::CalculateTimeEffortJob).with(time_effort_job.id)
    end
  ...
  describe '#calculation_processor' do
    ...
    it 'returns a processor' do
      expect(processor).to be_a(TimeeffortService::Processors::BaseProcessor)
    end
    ...
    context 'w/ richtext item' do
      ...
      it 'returns the correct processor for rich texts' do
        expect(processor).to be_an_instance_of(TimeeffortService::Processors::RichTextProcessor)
      end
    end
    ...
    context 'w/ video item' do
      ...
      it 'returns the correct processor for rich texts' do
        expect(processor).to be_an_instance_of(TimeeffortService::Processors::VideoProcessor)
      end
    end
    ...
    context 'w/ quiz item' do
      ...
      it 'returns the correct processor for rich texts' do
        expect(processor).to be_an_instance_of(TimeeffortService::Processors::QuizProcessor)
      end
    end
  end
