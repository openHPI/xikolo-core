...
RSpec.describe TimeeffortService::ItemDecorator, type: :decorator do
  ...
  context 'as_json' do
    ...
    it 'serializes resource as JSON' do
      expect(json_response).to eq(
        ...
        'overwritten_time_effort_url' => "http://test.host/timeeffort_service/items/#{item.id}/overwritten_time_effort"
      )
    end
  end
end
