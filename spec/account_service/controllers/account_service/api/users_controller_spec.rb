...
describe AccountService::API::UsersController, type: :controller do
  ...
  describe 'GET #show' do
    ...
    describe 'payload' do
      ...
      it { is_expected.to eq AccountService::UserDecorator.new(user.reload).as_json }
  ...
  describe 'PUT #update' do
    ...
    context 'with non-existent user' do
      ...
      let(:user) { AccountService::User.find 'c3b2068a-9525-4d5c-9672-6e547a10f6ba' }

      it { is_expected.to have_http_status :ok }

      it 'creates user record' do
        expect { response }.to change(AccountService::User, :count).from(1).to(2)
      ...
      describe 'payload' do
        ...
        it { is_expected.to eq AccountService::UserDecorator.new(user).as_json }
      end
    end
  end
    ...
    describe 'payload' do
      ...
      it 'returns the correct users' do
        expect(payload).to match_array \
          users.map {|u| AccountService::UserDecorator.new(u).as_json }
      end
    end
