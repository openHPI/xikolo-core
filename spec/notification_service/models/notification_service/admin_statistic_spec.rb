...
describe NotificationService::AdminStatistic, type: :model do
  ...
  let(:course_statistic) do
    NotificationService::CourseStats.verify({
  ...
  it 'has one course' do
    ...
    expect(course_info).to be_a(NotificationService::CourseStats)
