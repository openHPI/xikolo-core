...
describe PinboardService::SubscriptionsController, type: :controller do
  ...
  describe '#create' do
    it 'creates a new subscription' do
      ...
      end.to change(PinboardService::Subscription, :count).from(1).to(2)
    end
  end
  ...
  describe '#destroy' do
    it 'deletes subscription' do
      ...
      end.to change(PinboardService::Subscription, :count).from(1).to(0)
    end
  end
end
