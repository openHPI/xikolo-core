...
describe PinboardService::AnswersController, type: :controller do
  ...
  describe 'GET index' do
    ...
    it 'answers with answer resources' do
      action.call
      expect(json[0]).to eq(PinboardService::AnswerDecorator.new(answer).as_json.stringify_keys)
    end
  ...
  describe 'POST create' do
    ...
    it 'creates an answer on create' do
      expect { creation }.to change(PinboardService::Answer, :count).by(1)
    end
    ...
    context 'with image references' do
      ...
      it 'stores valid upload and creates a new richtext' do
        ...
        expect { creation }.to change(PinboardService::Answer, :count).by(1)
        expect(PinboardService::Answer.find(json['id']).text).to include 's3://xikolo-pinboard'
      end
    ...
    context 'with attachment upload' do
      ...
      it 'stores file and use it afterwards' do
        ...
        expect(PinboardService::Answer.find(json['id']).attachment_uri).not_to be_nil
      end
  ...
  describe 'DELETE destroy' do
    ...
    it 'does not delete the question record' do
      expect { action }.not_to change(PinboardService::Answer, :count)
    end
  end
end
