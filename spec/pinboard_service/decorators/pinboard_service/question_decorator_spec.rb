...
describe PinboardService::QuestionDecorator, type: :decorator do
  ...
  describe '#api_v1' do
    ...
    context 'attachment_url' do
      let(:question) { create(:'pinboard_service/question', attachment_uri: 's3://xikolo-pinboard/courses/3/thread/2/1/hans.jpg') }
    ...
    context 'within a collection' do
      ...
      context 'with answers' do
        ...
        context 'with answer_comments' do
          before do
            create(:'pinboard_service/comment', :for_answer, commentable: answer)
            create(:'pinboard_service/comment', :for_answer, commentable: answer, deleted: true)
          end
      ...
      context 'with comments' do
        before do
          create(:'pinboard_service/comment', commentable: question)
          create(:'pinboard_service/comment', commentable: question, deleted: true)
        end
  ...
  describe '#to_event' do
    ...
    context 'for technical question' do
      let(:question) { create(:'pinboard_service/technical_question') }
    ...
    describe 'text with embedded files' do
      ...
      let!(:question) { create(:'pinboard_service/question', text: text_with_uri) }
